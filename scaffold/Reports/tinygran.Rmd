...
sg_ratio_diff <- get_exclosure_diff(sg_ratio_gam, sg_ratio_pred, comparison_variable = "fplottype", comparison_level = 3)

sg_ratio_pred <- add_exclosure_diff(sg_ratio_pred, sg_ratio_diff)
...
tg_ratio_diff <- get_exclosure_diff(tg_ratio_gam, tg_ratio_pred, comparison_variable = "fplottype", comparison_level = 3)

tg_ratio_pred <- add_exclosure_diff(tg_ratio_pred, tg_ratio_diff)
...
#summary(pairs(lsmeans(ter_glm, specs = ~fplottype | era)))
