...
spei6 = spei(cbal, 6)$fitted, 
 ...
 ggplot(weather_full_drought, aes(date, spei6, color = spei6 > 0)) + geom_col() + scale_color_viridis_d(option = "turbo", begin = .1, end = .8, direction = -1)   + theme(legend.position = "none") + ggtitle("SPEI 6-month drought index")
ggplot(weather_full_drought, aes(date, spei12, color = spei12 > 0)) + geom_col() + scale_color_viridis_d(option = "turbo", begin = .1, end = .8, direction = -1)  + theme(legend.position = "none") + ggtitle("SPEI 12-month drought index")
ggplot(weather_full_drought, aes(date, spei18, color = spei18 > 0)) + geom_col() + scale_color_viridis_d(option = "turbo", begin = .1, end = .8, direction = -1)  + theme(legend.position = "none") + ggtitle("SPEI 18-month drought index")
