...
ggplot(compensation_pred, aes(timeperiods, emmean)) + geom_point() + geom_errorbar(aes(ymin = lower.CL, ymax = upper.CL)) + xlab("Time period") + ylab("Compensation %") + ggtitle("Energetic compensation for kangaroo rats") + ylim(0, 1) + geom_text(aes("1988-1996", .4, label = "a")) + geom_text(aes("1996-2010", .75, label = "b")) + geom_text(aes("2010-2020", .4, label = "a"))
...
ggplot(totale_pred, aes(timeperiods, emmean)) + geom_point() + geom_errorbar(aes(ymin = lower.CL, ymax = upper.CL)) + xlab("Time period") + ylab("Total energy on exclosures / controls") + ggtitle("Loss of energy use without kangaroo rats") + ylim(0, 1) + geom_text(aes("1988-1996", .4, label = "a")) + geom_text(aes("1996-2010", .8, label = "b")) + geom_text(aes("2010-2020", .6, label = "c"))
