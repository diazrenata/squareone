...
all_together_samples_big_summary_wide %>%
  group_by(era) %>%
  summarize(mean_mean_sg_minus_c_over_dipo = mean(mean_sg_minus_c_over_dipo),
            sd_mean_sg_minus_c_over_dipo = sd(mean_sg_minus_c_over_dipo, na.rm= T))


a_glm <- glm(mean_sg_minus_c_over_dipo ~ era, data = all_together_samples_big_summary_wide)
