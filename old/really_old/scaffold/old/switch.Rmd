...
ggplot(plot_totals, aes(period, total_e, color = plot_type, group = plot)) +
  geom_line() +
  scale_color_viridis_d(end = .8) +
  ggtitle("Total E by treatment") +
...
ggplot(treatment_means, aes(period, total_e, color = plot_type)) +
  ...
  facet_grid(cols = vars(era), scales = "free_x", space = "free") +
  theme(legend.position = "top")
ggplot(plot_totals, aes(period, smgran_e, color = plot_type, group = plot)) +
  geom_line() +
  scale_color_viridis_d(end = .8) +
  ggtitle("Small granivore E by treatment")+
  facet_grid(cols = vars(era), scales = "free_x", space = "free") +
  theme(legend.position = "top")
...
ggplot(plot_totals, aes(period, tinygran_e, color = plot_type, group = plot)) +
  geom_line() +
  scale_color_viridis_d(end = .8) +
  ggtitle("Tiny gran E  by treatment")+
  facet_grid(cols = vars(era), scales = "free_x", space = "free") +
  theme(legend.position = "top")
...
ggplot(treatment_means, aes(period, tinygran_e, color = plot_type)) +
  geom_line() +
  scale_color_viridis_d(end = .8) +
  ggtitle("Tiny granivore E by treatment")+
  facet_grid(cols = vars(era), scales = "free_x", space = "free") +
  theme(legend.position = "top")
...
tg_ratio_gam <- gam(tg_of_c ~ fplottype + s(period, k=20) + s(period, by = fplottype, k =20), family = "Gamma", data = treatment_ratios)
