---
title: "Results using June 1996 as the first boundary"
...
**Using the first observation of C. baileyi at the site - June 1996, for the first time period boundary!**
...
<!-- Modify the `oera` designations so that the first transition occurs at period 221, June 1996 -->
...
oera_df <- data.frame(
  ...
  `Timeperiod` = c("1988-1996", "1996-2010", "2010-2020")
)
...
contrasts_df <- data.frame(
  ...
  Comparison = c("1988-1996 - 1996-2010", "1988-1996 - 2010-2020", "1996-2010 - 2010-2020")
)
