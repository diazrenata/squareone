...
compensation_comparison<- data.frame(
  `Model specification` = c("intercept + timeperiod + plot (random) + autocorrelation",
                            "intercept + timeperiod + plot (random)",
                            "intercept + timeperiod + autocorrelation" ,
                            "intercept + plot (random) + autocorrelation",
...
To compare proportional energy use across time periods, we used generalized linear mixed models (using the `glmer` function in the R package `lme4`; Bates et al. 2015) with a binomial link function and a random effect of plot. 
...
dipo_comparison<- data.frame(
  `Model specification` = c("intercept + timeperiod + plot (random)",
                            "intercept + plot (random)",
...
pb_comparison <- data.frame(
  `Model specification` = c("intercept + timeperiod + treatment + timeperiod:treatment + plot (random)",
                            "intercept + timeperiod + treatment + plot (random)",
                            "intercept + timeperiod + plot (random)",
                            "intercept + plot (random)",
